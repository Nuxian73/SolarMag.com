...
namespace SolarMag.com.Controllers
{
    public class CommandesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DateCommande,Coordonnee")] Commande commande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DateCommande,Coordonnee")] Commande commande)
        {
            if (ModelState.IsValid)
            {
